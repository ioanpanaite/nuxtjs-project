          ...
          <div class="bg-muted-50 dark:bg-muted-700/40 p-6">
            <div class="flex items-center">
              ...
              <div class="ms-3">
                ...
                <p class="text-muted-400 font-sans text-xs">{{ data?.profile?.email }}</p>
              </div>
            </div>
          </div>
          <div class="p-2">
            <MenuItem as="div" v-slot="{ active }">
            <NuxtLink to="/profile/profile-edit"
            ...
            <NuxtLink to="/dashboards/users"
              ...
              <div class="ms-3">
                ...
                <p class="text-muted-400 font-sans text-xs">Manage Users</p>
              </div>
            </NuxtLink>
            </MenuItem>
            <MenuItem as="div" v-slot="{ active }">
            <NuxtLink to="/dashboards/frontend"
              class="group flex w-full items-center rounded-md p-3 text-sm transition-colors duration-300" :class="[
                active
                  ? 'bg-muted-100 dark:bg-muted-700 text-primary-500'
                  : 'text-muted-400',

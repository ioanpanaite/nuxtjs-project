        ...
        <BaseCard class="p-5">
          <div class="flex flex-col items-center md:flex-row">
            ...
            <div
              ...
              <div class="flex-1">
                <BaseHeading as="h3" size="3xl" weight="semibold" lead="tight" class="text-muted-800 dark:text-white">
                  <span>
                    31
              ...
              <BaseCard
                ...
                <div class="relative z-20 flex flex-col gap-3">
                  ...
                  <NuxtLink class="font-sans text-sm text-white underline-offset-4 hover:underline" to="#">
                    Learn More
                  </NuxtLink>
                </div>
                <div class="absolute bottom-0 end-2 z-10 flex h-14 w-14 items-center justify-center">
                  <Icon name="ph:crown-duotone" class="text-primary-900/50 h-10 w-10"></Icon>
                </div>
              </BaseCard>
            </div>
          </div>
      ...
      <div class="ltablet:col-span-4 col-span-12 lg:col-span-4">
        ...
        <div class="ptablet:grid-cols-2 grid gap-6 lg:flex lg:flex-col">
          ...
          <BaseCard class="p-6">
            <PlaceholderCompact>
              <template #image>
                <img src="/img/illustrations/placeholders/flat/chart-guy.svg" class="block w-full dark:hidden" width="225"
                  height="150" alt="Placeholder illustration" />
                <img src="/img/illustrations/placeholders/flat/chart-guy-dark.svg" class="hidden w-full dark:block"
                  width="225" height="150" alt="Placeholder illustration" />
              </template>
              <BaseHeading as="h4" size="lg" weight="light" lead="tight" class="text-muted-800 mb-1 dark:text-white">

...
definePageMeta({
  ...
  preview: {
    title: 'Banking Cryptocurrency dashboard',
  ...
  <div>
    ...
    <div class="mb-6 flex flex-col justify-between gap-y-4 sm:flex-row sm:items-center">
      <div>
        ...
        <BaseHeading size="3xl" weight="bold" class="text-muted-800 dark:text-white">
          <span
      ...
      <div class="flex gap-2 sm:justify-end">
        <BaseButtonAction :color="activePeriod === 'hour' ? 'primary' : 'default'" @click="activePeriod = 'hour'">
          Hour
        </BaseButtonAction>
        <BaseButtonAction :color="activePeriod === 'day' ? 'primary' : 'default'" @click="activePeriod = 'day'">
          Day
        </BaseButtonAction>
        <BaseButtonAction :color="activePeriod === 'week' ? 'primary' : 'default'" @click="activePeriod = 'week'">
          Week
        </BaseButtonAction>
        <BaseButtonAction :color="activePeriod === 'month' ? 'primary' : 'default'" @click="activePeriod = 'month'">
          Month
        </BaseButtonAction>
        <BaseButtonAction :color="activePeriod === 'year' ? 'primary' : 'default'" @click="activePeriod = 'year'">
          Year
        </BaseButtonAction>
      </div>
    </div>
          ...
          <div class="relative">
            <BaseCard class="p-8">
              <div class="mb-6 flex items-center gap-2">
                <Icon name="cryptocurrency:btc" class="h-9 w-9 text-orange-400" />
                <div>
                  <BaseHeading as="h3" size="md" weight="semibold" lead="snug" class="text-muted-800 dark:text-white">
                    <span>Bitcoin</span>
                  </BaseHeading>
                  <BaseParagraph size="xs" weight="semibold" class="text-muted-500 dark:text-muted-400">
                    BTC
                  </BaseParagraph>
                </div>
                <div class="ms-auto">
                  <BaseButtonAction size="sm" class="text-muted-500 dark:text-muted-400">
                    Currencies
                  </BaseButtonAction>
                </div>
              </div>

...
if (!route.query.user || !data?.value) {
  toaster.clearAll()
  toaster.show({
    title: 'Oops!',
...
const generalUrl = `/users/user-edit?user=${route.query.user}`
const subscriptionUrl = `/users/user-edit/subscription?user=${route.query.user}`
      ...
      <div class="col-span-12 sm:col-span-4">
        ...
        <div class="mt-8 max-w-[240px]">
          <ul class="space-y-1 font-sans text-sm">
            ...
            <li>
              <NuxtLink :to="subscriptionUrl" exact-active-class="!text-primary-500 !bg-primary-500/10"
                class="text-muted-400 hover:text-muted-600 dark:hover:text-muted-200 hover:bg-muted-50 dark:hover:bg-muted-700/50 flex items-center gap-2 rounded-lg p-3 transition-colors duration-300">
